...
export class StringInterpolationComponent {
  ...
  answer1: string = "Data binding is the way to communicate between the typescript code of your component and the html view."
  ...
  explanation: string = "In our component (string-interpolation.component.ts) we have declared and initialized a property of type string, named: 'stringInterpolation'. For us to display the property in our view(UI(html) we use string interpolation. String Interpolation uses curly braces ( {{}} ) to call the propery from our component to the view  and it only works for string types only. That is how the data is getting transferred from component to view.";
